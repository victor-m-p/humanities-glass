...
n_simulation = 2000 # first simulation is self so this gives n = 100
...
@time begin 
for unique_config in starting_config_id
    original_config = unique_config 
    for sim_number in 1:n_simulation
        ...
        for time_step in 1:n_timestep
            push!(sample_list, [sim_number, time_step, original_config, id])
...
outpath = replace(dir, "analysis" => f"data/sim/messalians.csv")
