...
# read file 
a, b, c, d, e = 541, 21, 20, 471, 4
samp = readdlm("/home/vpoulsen/humanities-glass/analysis/pars/matrix_nrow_$(a)_ncol_$(b)_nuniq_$(c)_suniq_$(d)_maxna_$(e).txt.mpf_params_NN1_LAMBDA0.411147", Float64)

f = "/home/vpoulsen/humanities-glass/analysis/pars/matrix_nrow_$(a)_ncol_$(b)_nuniq_$(c)_suniq_$(d)_maxna_$(e).txt.mpf_params_NN1_LAMBDA0.411147"
f
...
# save samples 
writedlm("/home/vpoulsen/humanities-glass/analysis/data_tmp/samp_test.txt", samp) # fix paths